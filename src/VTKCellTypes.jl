...
# Linear cells
const VTK_EMPTY_CELL       = VTKCellType("VTK_EMPTY_CELL",      UInt8(0), -1)
...
const VTK_PENTAGONAL_PRISM = VTKCellType("VTK_PENTAGONAL_PRISM",UInt8(15),-1)
const VTK_HEXAGONAL_PRISM  = VTKCellType("VTK_HEXAGONAL_PRISM", UInt8(16),-1)
...
const VTK_QUADRATIC_WEDGE                  = VTKCellType("VTK_QUADRATIC_WEDGE",                 UInt8(26),-1)
const VTK_QUADRATIC_PYRAMID                = VTKCellType("VTK_QUADRATIC_PYRAMID",               UInt8(27),-1)
const VTK_BIQUADRATIC_QUAD                 = VTKCellType("VTK_BIQUADRATIC_QUAD",                UInt8(28),-1)
const VTK_TRIQUADRATIC_HEXAHEDRON          = VTKCellType("VTK_TRIQUADRATIC_HEXAHEDRON",         UInt8(29),-1)
const VTK_QUADRATIC_LINEAR_QUAD            = VTKCellType("VTK_QUADRATIC_LINEAR_QUAD",           UInt8(30),-1)
const VTK_QUADRATIC_LINEAR_WEDGE           = VTKCellType("VTK_QUADRATIC_LINEAR_WEDGE",          UInt8(31),-1)
const VTK_BIQUADRATIC_QUADRATIC_WEDGE      = VTKCellType("VTK_BIQUADRATIC_QUADRATIC_WEDGE",     UInt8(32),-1)
const VTK_BIQUADRATIC_QUADRATIC_HEXAHEDRON = VTKCellType("VTK_BIQUADRATIC_QUADRATIC_HEXAHEDRON",UInt8(33),-1)
const VTK_BIQUADRATIC_TRIANGLE             = VTKCellType("VTK_BIQUADRATIC_TRIANGLE",            UInt8(34),-1)

# Cubic, isoparametric cell
const VTK_CUBIC_LINE                       = VTKCellType("VTK_CUBIC_LINE",UInt8(35),-1)
